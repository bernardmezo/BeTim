...
const values = [
  {
    ...
    title: "Misi Kami",
    description:
      "Memberdayakan UMKM lokal dengan menyediakan platform digital yang mudah diakses untuk meningkatkan visibilitas dan penjualan mereka di era digital.",
    gradient: "from-teal-600 to-cyan-600",
  },
  {
    icon: Users,
    title: "Komunitas",
    description:
      "Membangun ekosistem yang kuat antara UMKM dan konsumen lokal, menciptakan hubungan berkelanjutan yang saling menguntungkan.",
    gradient: "from-cyan-600 to-emerald-600",
  },
  {
    icon: Heart,
    title: "Dedikasi",
    description:
      "Berkomitmen penuh untuk mendukung pertumbuhan ekonomi lokal dengan memberikan layanan terbaik kepada setiap mitra UMKM kami.",
    gradient: "from-emerald-600 to-teal-600",
  },
];
...
const benefits = [
  ...
  "Komunitas UMKM yang solid",
];

const features = [
  {
    icon: Zap,
    title: "Mudah Bergabung",
    desc: "Proses pendaftaran yang cepat dan sederhana",
    gradient: "from-teal-600 to-cyan-600",
  },
  {
    icon: ShieldCheck,
    title: "Dukungan Penuh",
    desc: "Tim kami siap membantu kesuksesan bisnis Anda",
    gradient: "from-cyan-600 to-emerald-600",
  },
  {
    icon: Rocket,
    title: "Berkembang Bersama",
    desc: "Akses ke komunitas dan peluang pertumbuhan",
    gradient: "from-emerald-600 to-teal-600",
  },
];
    ...
    >
      <div className="relative">
        <div className="flex justify-center mb-6">
          <div className="bg-white/20 backdrop-blur-sm p-5 rounded-2xl relative overflow-hidden group-hover:scale-110 transition-transform duration-500">
            <stat.icon className="w-10 h-10 relative z-10" />
        ...
        <div className="text-white/95 font-semibold text-base md:text-lg">{stat.label}</div>
      </div>
    </motion.div>
  );
};
...
export default function AboutSection() {
  return (
    <div className="min-h-screen py-12 bg-gradient-to-b from-white via-slate-50 to-white">
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-x-6 gap-y-3 sm:gap-6 text-sm"
            >
              <div className="flex items-center gap-2 text-slate-600">
                <CheckCircle2 className="w-5 h-5 text-teal-600" />
                <span className="font-semibold">Gratis Bergabung</span>
              </div>
              <div className="flex items-center gap-2 text-slate-600">
                <CheckCircle2 className="w-5 h-5 text-teal-600" />
              ...
              <div className="flex items-center gap-2 text-slate-600">
                <CheckCircle2 className="w-5 h-5 text-teal-600" />
                <span className="font-semibold">Verifikasi Cepat</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* Stats Section */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-teal-600 via-cyan-600 to-emerald-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4 tracking-tight">
              <span className="text-slate-900">Visi & </span>
              <span className="bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 bg-clip-text text-transparent">
                Nilai Kami
              </span>
            </h2>
            ...
            <p className="text-slate-500 text-base md:text-xl max-w-3xl mx-auto leading-relaxed">
              Kami percaya bahwa setiap UMKM memiliki potensi untuk berkembang
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
            {values.map((value, index) => (
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-500 border border-white/60 group relative overflow-hidden"
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${value.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />

                <div className={`bg-gradient-to-br ${value.gradient} w-16 h-16 rounded-xl flex items-center justify-center mb-6 relative z-10 group-hover:scale-110 transition-transform duration-500`}>
                  <value.icon className="w-8 h-8 text-white" strokeWidth={2.5} />
                </div>

                <h3 className="text-2xl font-bold text-slate-900 mb-4 relative z-10">{value.title}</h3>
                <p className="text-slate-600 leading-relaxed text-base relative z-10">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="space-y-6">
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight">
                <span className="text-slate-900">Cerita </span>
                <span className="bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 bg-clip-text text-transparent">
                  Kami
                </span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <motion.div className="bg-white/70 backdrop-blur-xl rounded-xl p-6 shadow-md border border-white/60 hover:shadow-lg transition-all duration-300" whileHover={{ scale: 1.03 }} transition={{ duration: 0.3 }}>
                  <div className="text-3xl font-extrabold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent mb-2">2025</div>
                  <div className="text-slate-600 font-medium">Tahun Berdiri</div>
                </motion.div>

                <motion.div className="bg-white/70 backdrop-blur-xl rounded-xl p-6 shadow-md border border-white/60 hover:shadow-lg transition-all duration-300" whileHover={{ scale: 1.03 }} transition={{ duration: 0.3 }}>
                  <div className="text-3xl font-extrabold bg-gradient-to-r from-cyan-600 to-emerald-600 bg-clip-text text-transparent mb-2">Depok</div>
                  <div className="text-slate-600 font-medium">Beji Timur</div>
                </motion.div>
              </div>
            </motion.div>
      ...
      <section className="py-16 md:py-20 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4 tracking-tight">
              <span className="text-slate-900">Tim </span>
              <span className="bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 bg-clip-text text-transparent">
                Kami
              </span>
            </h2>

            <p className="text-slate-500 text-base md:text-lg max-w-xl mx-auto">Orang-orang hebat di balik kesuksesan BeTim</p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {team.map((member, index) => (
              <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.15, duration: 0.5 }} whileHover={{ y: -8 }} className="group">
                <div className="bg-white/70 backdrop-blur-xl rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 border border-white/60">
                  <div className="relative h-80 bg-gradient-to-br from-teal-600 to-cyan-600 overflow-hidden">
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-30 pointer-events-none">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-300/40 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-emerald-300/40 rounded-full blur-[120px]" />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-5xl mx-auto">
            <div className="flex justify-center mb-10">
              <div className="bg-gradient-to-br from-teal-600 to-emerald-600 p-4 rounded-2xl shadow-xl">
                <Sparkles className="w-10 h-10 text-white" />
              </div>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-extrabold mb-8 text-slate-900 tracking-tight">
                Siap Bergabung dengan{" "}
                <span className="bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 bg-clip-text text-transparent">Komunitas BeTim?</span>
              </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <motion.button
                className="bg-gradient-to-r from-teal-600 to-emerald-600 text-white font-bold text-base md:text-lg rounded-2xl py-3 px-6 sm:py-4 sm:px-10 hover:shadow-xl hover:shadow-teal-500/30 transition-all duration-300 transform group"
              ...
              <motion.button
                className="bg-white text-teal-600 font-bold text-base md:text-lg rounded-2xl py-3 px-6 sm:py-4 sm:px-10 hover:bg-slate-50 transition-all duration-300 border-2 border-teal-600 transform group shadow-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              >
                <span className="flex items-center justify-center gap-2">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-white/60 shadow-lg mb-12">
              <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-6 text-center">Keuntungan Bergabung dengan BeTim</h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {benefits.map((benefit, index) => (
                  <motion.div key={index} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1, duration: 0.4 }} className="flex items-start gap-3 group">
                    <CheckCircle2 className="w-6 h-6 text-teal-600 flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.15, duration: 0.5 }} whileHover={{ y: -5 }} className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/60 hover:shadow-xl transition-all duration-500 group">
                  <div className={`bg-gradient-to-br ${feature.gradient} w-12 h-12 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-500`}>
                    <feature.icon className="w-6 h-6 text-white" strokeWidth={2.5} />
                  </div>
                  <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-teal-600 transition-colors duration-300">{feature.title}</h3>
